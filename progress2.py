...
class pb2:
    ...
    def update(self, tag, nowValue, fullValue, customVisualbar=None):
        with self.__lock:
            self.__od[tag] = self.customVisualbar(tag, nowValue,
                                                  fullValue) if customVisualbar is None else customVisualbar(tag,
                                                                                                             nowValue,
                                                                                                             fullValue)

            self.__dirty = True

    def customVisualbar(self, tag, nowValue, fullValue):
        bar_length = 100
